...
//드워프가 광산에 들어가면, 백설 공주는 다시 집으로 돌아가서 찍은 사진 중에 업로드 할 예쁜 사진을 선택한다. 각각의 드워프는 모두 모자를 
//쓰고 있으며 모자의 색상은 총 C 가지가 있다. 사진에 찍힌 드워프가 쓰고 있는 모자의 색상 중 절반보다 많은 색이 같은 색이라면 예쁜 사진이다.
//즉, 사진에 드워프가 K명 찍혀있고, K/2보다 많은 드워프의 모자 색이 같다면 예쁜 사진이다.
